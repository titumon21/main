            ...
            <div class="row justify-content-center">
                <%
                    ...
                    try {
                        ...
                        String qrys = "select *from hospital";
                ...
                <div class="col-lg-4 col-md-6 column column-img mx-lg-2 mx-3" id="zoomIn">
                    <div class="services-gd">
                        <div class="serve-info">
                            <a href="#blog">
                                <figure>
                                    <img class="img-responsive" src="assets/images/hospital.jpg" alt="blog-image">
                                </figure>
                            </a>
                            ...
                            <p>  <%=v.get(2)%>.</p>
                            <div><a href="./PROCESS/RemoveHospital.jsp?id=<%=v.get(0)%>" class="btn button-style">Remove</a></div>
                        </div>
                    </div>
                </div>
