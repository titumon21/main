    ...
    <div class="services-layout py-md-4 py-3">
        <div class="container">
            <div class="text-center mb-sm-5 mb-4">
                <label class="sub-title mb-2"></label>
            ...
            <div class="row justify-content-center">
                <%
                    ...
                    try {
                        ...
                        String qrys = "select *from fuel_station";
                ...
                <div class="col-lg-4 col-md-6 column column-img mx-lg-2 mx-3" id="zoomIn">
                    <div class="services-gd">
                        <div class="serve-info">
                            <a href="#blog">
                                <figure>
                                    <img class="img-responsive" src="assets/images/fuel_station.jpg" alt="blog-image">
                                </figure>
                            </a>
                            ...
                            <ul class="admin-list">
                                <li><a href="#blog"><span class="fa fa-user-circle icon-color"
                                        ...
                                        <%=v.get(2)%></a></li>
                                <li><a href="#blog"></span><%=v.get(4)%></a></li>
