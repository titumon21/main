<%-- 
    Document   : AddWorkshops
    Created on : 27 Mar, 2022, 11:25:55 AM
    Author     : admin
--%>
    ...
    <section class="w3l-breadcrumb">
        <div class="container">
            ...
            <ul class="breadcrumbs-custom-path">
                ...
                <li class="active"><span class="fa fa-chevron-right mx-2" aria-hidden="true"></span> Add Workshops</li>
            </ul>
        </div>
    </section>
</div>
                    ...
                    <form action="./PROCESS/addworkshopprocess.jsp" method="post" class="signin-form">
                        <div class="input-grids">
                            ...
                            <input type="text"  pattern="[789][0-9]{9}" maxlength="10" name="phone" id="w3lSubect" placeholder="Phone*"
                                   class="contact-input" required="" />
                             <input type="text"  name="dist" id="w3lSubect" placeholder="District*"
                                   class="contact-input" required="" />
